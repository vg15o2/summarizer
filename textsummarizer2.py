...
from transformers import pipeline  # Hugging Face library for text summarization
...
import sys  # Library for command-line arguments
...
def chunk_and_summarize(text, chunk_size=1000):
    """
    Breaks the text into chunks and summarizes each chunk.

    :param text: Text to chunk and summarize
    :param chunk_size: Desired chunk size in words
